...
export default function mcpAdapter(pi: ExtensionAPI) {
  ...
  // Slash-command UI is provided by the local wrapper in ../mcp.ts.
  // Keep this vendored adapter focused on MCP runtime, proxy/direct tools,
  // lifecycle, OAuth plumbing, and metadata cache so the global package dialogs
  // do not appear.
